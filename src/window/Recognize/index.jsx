...
import { createServiceInstanceConfigLifecycle } from '../Translate/service_config_events';
...
export default function Recognize() {
    ...
    const serviceConfigGenerationRef = useRef(0);
    ...
    useEffect(() => {
        if (serviceInstanceList === null) return;
        const generation = ++serviceConfigGenerationRef.current;
        const lifecycle = createServiceInstanceConfigLifecycle({
            serviceInstanceLists: [serviceInstanceList],
            listenEvent: listen,
            loadConfig: (serviceInstanceKey) => store.get(serviceInstanceKey),
            setServiceInstanceConfigMap,
            generation,
            isCurrentGeneration: (candidate) => serviceConfigGenerationRef.current === candidate,
        });

...
export default function LanguageArea() {
    ...
    return (
        <Card
            shadow='none'
            className='translate-language-bar'
        >
            <CardFooter className='translate-language-grid'>
                    ...
                    <Dropdown>
                        <DropdownTrigger>
                            <Button
                                radius='sm'
                                variant='light'
                                className='translate-language-button'
                            >
                ...
                <div className='flex'>
                    <Button
                        ...
                        className='translate-language-swap text-[20px]'
                        onPress={async () => {

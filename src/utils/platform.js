...
const PLATFORM_PRESENTATIONS = Object.freeze({
    [DESKTOP_PLATFORM.WINDOWS]: Object.freeze({
        ...
        speechDescription: '使用系统 SpeechSynthesizer，可分别选择中英文自然音色；零下载、零显存。',
        speechVoicePlaceholder: '自动选择 Windows 声音',
        speechChineseVoicePlaceholder: '自动选择 Windows 中文声音',
        speechEnglishVoicePlaceholder: '自动选择 Windows 英文声音',
    ...
    [DESKTOP_PLATFORM.MACOS]: Object.freeze({
        ...
        speechDescription: '使用 macOS 系统 say，可分别选择中英文自然音色；零下载、零显存。',
        speechVoicePlaceholder: '自动选择 macOS 声音',
        speechChineseVoicePlaceholder: '自动选择 macOS 中文声音',
        speechEnglishVoicePlaceholder: '自动选择 macOS 英文声音',
    ...
    [DESKTOP_PLATFORM.LINUX]: Object.freeze({
        ...
        speechDescription: '使用系统 espeak-ng（兼容 espeak），中英文音色独立配置；零下载、零显存。',
        speechVoicePlaceholder: '自动选择 Linux 声音（需安装 espeak-ng）',
        speechChineseVoicePlaceholder: '自动选择 Linux 中文声音（需安装 espeak-ng）',
        speechEnglishVoicePlaceholder: '自动选择 Linux 英文声音（需安装 espeak-ng）',
    ...
    [DESKTOP_PLATFORM.UNKNOWN]: Object.freeze({
        ...
        speechTitle: '系统本地朗读',
        speechStatus: '系统本地语音',
        speechDescription: '使用当前系统可用的本地语音，中英文音色独立配置；零下载、零显存。',
        speechVoicePlaceholder: '自动选择系统声音',
        speechChineseVoicePlaceholder: '自动选择系统中文声音',
        speechEnglishVoicePlaceholder: '自动选择系统英文声音',
